...
gh variable set TF_PLAN_ROLE_ARN --body "$(terraform -chdir=infra output -raw github_terraform_plan_role_arn)"
# ✓ Created variable TF_PLAN_ROLE_ARN for simonangel-fong/kubeflow-yolo

gh variable set TF_APPLY_ROLE_ARN --body "$(terraform -chdir=infra output -raw github_terraform_apply_role_arn)"
# ✓ Created variable TF_APPLY_ROLE_ARN for simonangel-fong/kubeflow-yolo

# gate apply behind required reviewers before the first run
gh api -X PUT repos/simonangel-fong/kubeflow-yolo/environments/tf-apply \
